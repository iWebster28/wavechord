# Make sure to have conda installed on your computer
# HOMEPATH ~ % bash Miniconda3-latest-MacOSX-x86_64.sh
# HOMEPATH ~ % touch .bash_profile
# HOMEPATH ~ % open ~/.bash_profile                    
# HOMEPATH ~ % source ~/.zshrc

#  onda install pytorch torchvision -c pytorch
